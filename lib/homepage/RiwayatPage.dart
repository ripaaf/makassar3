            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  padding: EdgeInsets.fromLTRB(21*fem, 37.81*fem, 24*fem, 293.3*fem),
                  width: double.infinity,
                  decoration: BoxDecoration (
                    color: Color(0xffffffff),
                  ),
                  child: Column(
                    ...
                    children: [
                      Container(
                        // group689TtJ (115:46)
                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 21.18*fem),
                        width: 336*fem,
                        decoration: BoxDecoration (
                          color: Color(0xffffffff),
                        ...
                        child: TextField(
                          decoration: InputDecoration (
                            ...
                            contentPadding: EdgeInsets.fromLTRB(15*fem, 10.19*fem, 15*fem, 10.82*fem),
                          ),
                        ),
                      ),
                      Container(
                      ...
                      Container(
                        // group5023Li (115:32)
                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 3*fem, 22.3*fem),
                        padding: EdgeInsets.fromLTRB(15.3*fem, 9.35*fem, 9*fem, 16.35*fem),
                        width: double.infinity,
                        height: 90.7*fem,
                        decoration: BoxDecoration (
                          ...
                          gradient: LinearGradient (
                            ...
                            colors: <Color>[Color(0xff6894de), Color(0xff568de8), Color(0xff528bea), Color(0xff4e89ed), Color(0xff4285f4)],
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 61.7*fem, 0*fem),
                              width: 159*fem,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    margin: EdgeInsets.fromLTRB(0.7*fem, 0*fem, 59.3*fem, 0*fem),
                                    width: double.infinity,
                                    child: Row(
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                      children: [
                      ...
                      Container(
                        ...
                        padding: EdgeInsets.fromLTRB(15.3*fem, 9.35*fem, 23*fem, 16.35*fem),
                        width: 342*fem,
                        decoration: BoxDecoration (
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    margin: EdgeInsets.fromLTRB(0*fem, 5*fem, 149*fem, 0*fem),
                                    constraints: BoxConstraints (
                                      maxWidth: 62*fem,
                                    ),
                                    child: Text(
